...
/**
 * This is the item provider adapter for a {@link ca.mcgill.sure.variablecalibration.Value} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ValueItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Hillslope1DPackage.Literals.VALUE__VALUE,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Value.class)) {
			case Hillslope1DPackage.VALUE__VALUE:
