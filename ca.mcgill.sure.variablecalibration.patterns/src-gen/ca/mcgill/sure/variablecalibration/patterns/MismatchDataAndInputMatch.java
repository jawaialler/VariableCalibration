...
/**
 * Pattern-specific match representation of the ca.mcgill.sure.variablecalibration.patterns.mismatchDataAndInput pattern,
 * to be used in conjunction with {@link MismatchDataAndInputMatcher}.
 * 
...
public abstract class MismatchDataAndInputMatch extends BasePatternMatch {
  private Configuration fConf;
  
  private static List<String> parameterNames = makeImmutableList("conf");
  
  private MismatchDataAndInputMatch(final Configuration pConf) {
    this.fConf = pConf;
  }
  ...
  public List<String> parameterNames() {
    return MismatchDataAndInputMatch.parameterNames;
  }
  ...
  @Override
  public MismatchDataAndInputMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof MismatchDataAndInputMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    MismatchDataAndInputMatch other = (MismatchDataAndInputMatch) obj;
  ...
  @Override
  public MismatchDataAndInputQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static MismatchDataAndInputMatch newEmptyMatch() {
   ...
   * 
   */
  public static MismatchDataAndInputMatch newMutableMatch(final Configuration pConf) {
   ...
   * 
   */
  public static MismatchDataAndInputMatch newMatch(final Configuration pConf) {
    return new Immutable(pConf);
  }
  
  private static final class Mutable extends MismatchDataAndInputMatch {
  ...
  private static final class Immutable extends MismatchDataAndInputMatch {
