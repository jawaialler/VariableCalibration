...
/**
 * A pattern-specific query specification that can instantiate QueryNameMatcher in a type-safe way.
 * 
 * @see QueryNameMatcher
 * @see QueryNameMatch
 * 
 */
@SuppressWarnings("all")
final class QueryNameQuerySpecification extends BaseGeneratedEMFQuerySpecification<ViatraQueryMatcher<IPatternMatch>> {
  private QueryNameQuerySpecification() {
   ...
   * 
   */
  public static QueryNameQuerySpecification instance() throws ViatraQueryException {
    try{
  ...
  /**
   * Inner class allowing the singleton instance of {@link QueryNameQuerySpecification} to be created 
   * 	<b>not</b> at the class load time of the outer class, 
   * 	but rather at the first call to {@link QueryNameQuerySpecification#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static QueryNameQuerySpecification INSTANCE = new QueryNameQuerySpecification();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static QueryNameQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public String getFullyQualifiedName() {
      return "ca.mcgill.sure.variablecalibration.patterns.queryName";
    }
