...
/**
 * A pattern-specific query specification that can instantiate ValuesOfInputMatcher in a type-safe way.
 * 
 * @see ValuesOfInputMatcher
 * @see ValuesOfInputMatch
 * 
 */
@SuppressWarnings("all")
final class ValuesOfInputQuerySpecification extends BaseGeneratedEMFQuerySpecification<ViatraQueryMatcher<IPatternMatch>> {
  private ValuesOfInputQuerySpecification() {
   ...
   * 
   */
  public static ValuesOfInputQuerySpecification instance() throws ViatraQueryException {
    try{
  ...
  /**
   * Inner class allowing the singleton instance of {@link ValuesOfInputQuerySpecification} to be created 
   * 	<b>not</b> at the class load time of the outer class, 
   * 	but rather at the first call to {@link ValuesOfInputQuerySpecification#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static ValuesOfInputQuerySpecification INSTANCE = new ValuesOfInputQuerySpecification();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static ValuesOfInputQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    private final List<PParameter> parameters = Arrays.asList(parameter_pInput, parameter_pValue);
    
    @Override
    public String getFullyQualifiedName() {
      return "ca.mcgill.sure.variablecalibration.patterns.valuesOfInput";
    }
    
    @Override
    public List<String> getParameterNames() {
      return Arrays.asList("input","value");
    }
      ...
      try {
      	{
      		...
      		new TypeConstraint(body, new FlatTuple(var_input, var__virtual_0_), new EStructuralFeatureInstancesKey(getFeatureLiteral("ca.mcgill.sure.variablecalibration", "Input", "possibleValues")));
